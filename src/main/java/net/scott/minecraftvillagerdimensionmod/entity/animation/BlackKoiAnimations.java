...
public class BlackKoiAnimations {
        public static final Animation swim = Animation.Builder.create(4.0F).looping()
                ...
                .addBoneAnimation("black_koi_fish", new Transformation(Transformation.Targets.ROTATE,
                ...
                .addBoneAnimation("black_koi_fish", new Transformation(Transformation.Targets.TRANSLATE,
