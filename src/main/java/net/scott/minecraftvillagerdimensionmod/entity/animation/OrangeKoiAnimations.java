...
public class OrangeKoiAnimations {
        public static final Animation swim = Animation.Builder.create(4.0F).looping()
                ...
                .addBoneAnimation("orange_koi_fish", new Transformation(Transformation.Targets.ROTATE,
                ...
                .addBoneAnimation("orange_koi_fish", new Transformation(Transformation.Targets.TRANSLATE,
